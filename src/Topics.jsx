...
const Topics = () => (
  <Router>
    <div className="tab">
      <ul>
        <h1>
          Click to view a few components I've built with React!
        </h1>
        <Link className="tablinks" to="/topics/drummachine">
          <button>Drum Machine</button>
        </Link>
        <Link className="tablinks" to="/topics/webdev100">
          <button>r/WebDev Top 100 Posts</button>
        </Link>
      </ul>
